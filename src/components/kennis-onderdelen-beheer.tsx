      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span
            className={clsx(
              "rounded-full px-2 py-0.5 text-[11px] font-medium",
              woordenlijst.categorie === "zinnen" ? "bg-violet-50 text-violet-700" : "bg-sky-50 text-sky-700"
            )}
          >
            {woordenlijst.categorie === "zinnen" ? "Zinnen & uitdrukkingen" : "Woordenschat"}
          </span>
          <span className="rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-medium text-slate-600">
      ...
      <Modal open={bewerken} onClose={() => setBewerken(false)} title="Woordenlijst bewerken">
        ...
        >
          ...
          <div>
            ...
            <select
              name="categorie"
              defaultValue={woordenlijst.categorie}
              className="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-sm focus:border-accent-500 focus:outline-none focus:ring-2 focus:ring-accent-100"
            >
              <option value="woordenschat">Woordenschat (losse woorden)</option>
              <option value="zinnen">Zinnen &amp; uitdrukkingen (complete zinnen)</option>
            </select>
          </div>
          <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-700">
