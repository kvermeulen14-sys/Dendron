...
export default async function OuderToetsweekPage() {
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Help je kind om in 1 keer leermomenten te plannen voor alle toetsen in een toetsweek,
          verdeeld naar hoeveel werk het per vak is.
        </p>
      </div>
